<template>
  <section>
    ...
    <div class="row at-row flex-center flex-middle">
      ...
      <div class="col-lg-6">
        <a href="https://github.com/comparexoss/cpx-oss-workshop" target="_blank"><at-button icon="icon-github" class="mid-btn" type="info" hollow>Steal This Code</at-button></a>
      </div>
      <div class="col-lg-3">
      </div>
    </div>
